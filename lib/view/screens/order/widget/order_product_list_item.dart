          ...
          Expanded(
            child: Column(crossAxisAlignment:CrossAxisAlignment.start, children: [
              ...
              Padding(
                ...
                child: Text('[${getTranslated('tax', context)} ${widget.orderDetailsModel!.productDetails!.taxModel}'+"("+widget.orderDetailsModel!.tax!.toStringAsFixed(0)+")]",style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),),
              ),
