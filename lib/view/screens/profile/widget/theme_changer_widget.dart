    ...
    return Column(
      children: [
        ...
        SectionItemWidget(icon: Images.delete, title: 'delete_account',
            onTap: () {
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please Contact Admin"),
                  backgroundColor: ColorResources.red));
              // showAnimatedDialog(context, const SignOutConfirmationDialog(isDelete: true), isFlip: true);
            }),
