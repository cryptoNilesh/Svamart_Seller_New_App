          ...
          child: Column( crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                  ...
                  DottedBorder(
                    ...
                    child: Stack(children: [
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: () => authProvider.pickImage(true,false,false,false, false),
                          child: Container(
              ...
              if(widget.isShopInfo)Column(children: [
                ...
                Align(alignment: Alignment.center, child: DottedBorder(
                  ...
                  child: Stack(children: [
                    ...
                    Positioned(
                      bottom: 0, right: 0, top: 0, left: 0,
                      child: InkWell(
                        onTap: () => authProvider.pickImage(false,false,false,true, false),
                        child: Container(
                          decoration: BoxDecoration(
                            color: Theme.of(context).hintColor.withOpacity(.08),
                            borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                ...
                Align(alignment: Alignment.center, child: DottedBorder(
                  ...
                  child: Stack(children: [
                    ...
                    Positioned(
                      bottom: 0, right: 0, top: 0, left: 0,
                      child: InkWell(
                        onTap: () => authProvider.pickImage(false,false,false,false, false),
                        child: Container(
                          decoration: BoxDecoration(
                ...
                Align(alignment: Alignment.center, child: DottedBorder(
                  ...
                  child: Stack(children: [
                    ...
                    Positioned(
                      bottom: 0, right: 0, top: 0, left: 0,
                      child: InkWell(
                        onTap: () => authProvider.pickImage(false,false,false,false, false, secondary: true),
                        child: Container(
                          decoration: BoxDecoration(
                            color: Theme.of(context).hintColor.withOpacity(0.08),
                            borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                ...
                const SizedBox(height: Dimensions.paddingSizeDefault),
                Center(child: Text("Document", style: robotoRegular.copyWith(
                ...
                Container(
                    ...
                    child: CustomTextField(
                      border: true,
                      hintText: "Aadhar No.",
                      focusNode: authProvider.AadharNoNode,
                      nextNode: authProvider.shopAddressNode,
                      textInputType: TextInputType.number,
                      controller: authProvider.aadharController,
                      textInputAction: TextInputAction.next,
                    )),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                Padding(
                ...
                Align(alignment: Alignment.center, child: DottedBorder(
                  ...
                  child: Stack(children: [
                    ClipRRect(
                      borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                      child: authProvider.aadharDocument != null ?  Image.file(File(authProvider.aadharDocument!.path),
                        width: MediaQuery.of(context).size.width - 40, height: 120, fit: BoxFit.cover,
                      ) :SizedBox(height: 120,
                        width: MediaQuery.of(context).size.width - 40,
                        child: Image.asset(Images.cameraPlaceholder, scale: 3, ),
                    ...
                    Positioned(
                      bottom: 0, right: 0, top: 0, left: 0,
                      child: InkWell(
                        onTap: () => authProvider.pickImage(false,true,false,false, false, secondary: false),
                        child: Container(
                          decoration: BoxDecoration(
                            color: Theme.of(context).hintColor.withOpacity(0.08),
                            borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                    ...
                    children: [Row(children: [
                      Consumer<AuthProvider>(
                          builder: (context, authProvider, child) => Checkbox(
                              ...
                              value: authProvider.isGST,
                              onChanged: authProvider.updateGST)),
                ...
                Container(
                    ...
                    child: CustomTextField(
                      border: true,
                      hintText: authProvider.isGST!=true?"PAN No.":"GST No.",
                      focusNode: authProvider.panGSTNode,
                      textInputType: TextInputType.text,
                      controller: authProvider.panGstController,
                      textInputAction: TextInputAction.next,
                    )),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                Padding(
                  padding: const EdgeInsets.only(left: Dimensions.paddingSizeLarge,
                      right: Dimensions.paddingSizeLarge, bottom: Dimensions.paddingSizeDefault),
                  child: Row(children: [
                    Text(authProvider.isGST!=true?'PAN Image':'GST Image',
                        style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  ],
                  ),
                ),
                ...
                Align(alignment: Alignment.center, child: DottedBorder(
                  ...
                  child: Stack(children: [
                    ClipRRect(
                      borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                      child: authProvider.pangstDocument != null ?  Image.file(File(authProvider.pangstDocument!.path),
                        width: MediaQuery.of(context).size.width - 40, height: 120, fit: BoxFit.cover,
                      ) :SizedBox(height: 120,
                        width: MediaQuery.of(context).size.width - 40,
                        child: Image.asset(Images.cameraPlaceholder, scale: 3, ),
                    ...
                    Positioned(
                      bottom: 0, right: 0, top: 0, left: 0,
                      child: InkWell(
                        onTap: () => authProvider.pickImage(false,false,true,false, false, secondary: false),
                        child: Container(
                          decoration: BoxDecoration(
                            color: Theme.of(context).hintColor.withOpacity(0.08),
                            borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
