...
class ShopProductWidget extends StatefulWidget {
  ...
  final int index;
  const ShopProductWidget({Key? key, required this.productModel, this.isDetails = false,required this.index}) : super(key: key);
      ...
      children: [
        ...
        Align(alignment: Provider.of<LocalizationProvider>(context, listen: false).isLtr? Alignment.topRight:Alignment.topLeft,
            child: Padding(
              ...
              child: Container(width: 110,height: 50,
                decoration: BoxDecoration(
                    color: Theme.of(context).cardColor,
            ...
            Consumer<ProductProvider>(
                builder: (context, details,_) {
                  return FlutterSwitch(
                                ...
                                toggleSize: 18,
                                valueFontSize: 10.0,
                                value: widget.productModel!.status==1?true:false,
                                borderRadius: 30.0,
                                padding: 3.0,
                                onToggle: (val) {
                                  ...
                                  if(widget.productModel!.status==0){
