...
class AuthProvider with ChangeNotifier {
  ...
  XFile? _panGstDocument;
  XFile? _shopBanner;
  XFile? secondaryBanner;
  XFile? get sellerProfileImage => _sellerProfileImage;
  XFile? get shopLogo => _shopLogo;
  XFile? get aadharDocument => _aadharDocument;
  XFile? get pangstDocument => _panGstDocument;
  ...
  TextEditingController panGstController = TextEditingController();
  ...
  FocusNode AadharNoNode = FocusNode();
  FocusNode panGSTNode = FocusNode();
  ...
  void pickImage(bool isProfile,bool aadhar,bool pangst, bool shopLogo, bool isRemove, {bool secondary = false}) async {
    if(isRemove) {
      _sellerProfileImage = null;
      _shopLogo = null;
      _shopBanner = null;
      _aadharDocument=null;
      _panGstDocument=null;
      ...
      if (isProfile) {
        ...
        _aadharDocument = await ImagePicker().pickImage(source: ImageSource.gallery);
      }else if(pangst){
        _panGstDocument = await ImagePicker().pickImage(source: ImageSource.gallery);
      }else {
